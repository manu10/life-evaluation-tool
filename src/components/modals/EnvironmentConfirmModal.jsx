    ...
    <div className="fixed inset-0 z-70 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-lg border border-gray-200 w-full max-w-lg max-h-[85vh] flex flex-col">
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-900">Engineer your environment</h3>
        ...
        <div className="px-6 py-4 overflow-y-auto space-y-3">
          {top.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-2">
              {top.map((it) => (
                <div key={it.type + it.text} className="flex items-center justify-between p-3 rounded-md bg-gray-50 border border-gray-200">
                  ...
                  <button
                    ...
                    onClick={() => apply(it)}
                    className={`px-3 py-1 text-xs rounded-md ${applied[it.text] ? 'bg-green-100 text-green-700 border border-green-300 cursor-default' : 'bg-amber-600 text-white hover:bg-amber-700'}`}
                  >
